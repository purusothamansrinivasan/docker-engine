# Docker Engine API MCP Server

This MCP (Model Content Protocol) server provides access to Docker Engine API API functionality through HTTP, HTTPS, and STDIO transport modes.
